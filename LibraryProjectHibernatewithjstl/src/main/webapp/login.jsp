...
<body>
	...
	<c:if test="${param.userName != null && param.password != null }">
		<jsp:useBean id="beanLibUsers" class="com.infinite.LibraryProjectHibernate.LibUsers" />
		<jsp:setProperty property="*" name="beanLibUsers"/>
		<jsp:useBean id="beanDao" class="com.infinite.LibraryProjectHibernate.LibraryDAO"/>
