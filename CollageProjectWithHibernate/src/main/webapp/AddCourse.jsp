...
<body>
<jsp:useBean id="dao" class="com.infinite.CollageProjectWithHibernate.CollegeDAO" />
...
<jsp:useBean id="course" class="com.infinite.CollageProjectWithHibernate.CourseList" />
